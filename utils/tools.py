...
def log(
    ...
    if losses is not None:
        ...
        if LM == "V2C":
            ...
            logger.add_scalar("Loss/speaker_loss", losses[12], step)
            logger.add_scalar("Loss/duration_loss", losses[13], step)
            logger.add_scalar("Loss/duration_MAE", losses[13], step)
